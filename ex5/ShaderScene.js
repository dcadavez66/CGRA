class ShaderScene extends CGFscene {
	...
	init(application) {
		...
		this.testShaders = [
			...
			new CGFshader(this.gl, "shaders/new_flat.vert" , "shaders/new_flat.frag"),
			new CGFshader(this.gl, "shaders/new_texture3anim.vert", "shaders/new_texture3anim.frag"),
	...
	update(t) {
		...
		if (this.selectedExampleShader == 6 ){
			...
			this.testShaders[12].setUniformsValues({ timeFactor: t / 500 % 1000 });	
		}
