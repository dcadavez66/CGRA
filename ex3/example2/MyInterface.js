...
class MyInterface extends CGFinterface {
    ...
    init(application) {
        ...
        var amb_light = this.gui.addFolder("Global amb light");
        amb_light.add(this.scene , 'amb_r' , 0.00 , 1.00).name("Red value");
        amb_light.add(this.scene , 'amb_g' , 0.00 , 1.00).name("Green value");
        amb_light.add(this.scene , 'amb_b' , 0.00 , 1.00).name("Blue value");
