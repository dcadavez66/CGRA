...
class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.tangram = new MyTangram(this,10);
        this.cube = new MyUnitCube(this, 10);
    ...
    initLights() {
        ...
        this.setGlobalAmbientLight(this.amb_r, this.amb_g, this.amb_b, 1.0);
    ...
    initMaterials() {
        ...
        //Wood type color (low specular)
        //0.6, 0.3, 0,
        this.materialWood = new CGFappearance(this);
        this.materialWood.setAmbient(0.6, 0.3, 0, 1.0);
        this.materialWood.setDiffuse(0.6, 0.3, 0, 1.0);
